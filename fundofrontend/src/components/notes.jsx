...
export default class Notes extends Component {
    ...
    handleColor = (noteId, value) => {
        ...
        deleteNote(data)
            .then(response => {
                console.log("RESPONSE_FROM_BACKEND_AT_NOTES_COLOR", response);

            })
            .catch(err => {
                console.log("ERROR_AT_COLOR_IN_NOTES", err);
            })


        // updateNote(data)color
        // .then(() => {
        //     this.getNotecolor
        // })
    ...
    handleDelete = (noteId) => {
        ...
        deleteNote(data)
            .then(response => {
                console.log("RESPONSE_FROM_BACKEND_AT_NOTES_DELETE", response);
